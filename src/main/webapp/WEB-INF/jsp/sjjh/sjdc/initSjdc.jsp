        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <!--添加任务模态框-->
                    <div class="modal fade" id="rwssxjModal" tabindex="-1" role="dialog" aria-label="myModalLabel">
                                ...
                                <div class="modal-body">
                                    <form id="editForm" method="post" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <%--<input id="bzwmc" name="bzwmc" type="text" style="width:200px;"--%>
                                                <%--class="form-control">--%>
                                            ...
                                            <div class="col-sm-3">
                                                <input id="bsjl" name="bsjl" type="text" style="width:100px;"
                                                       class="form-control">
                                            </div>
...
//        //成功方法
    ...
    function inittabs(rwmcs) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${pageContext.request.contextPath}/sjjh/sjdc/selectList",
//            search: true, //是否启用搜素
