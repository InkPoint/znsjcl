...
<script>
    ...
    function inittab(yzmcs){
        ...
        $('#mytab').bootstrapTable({
            url:'${pageContext.request.contextPath}/sjjh/sjyz/list',
//            search: true, //是否启用搜素
    ...
    function del(){
        ...
        if(confirm(msg) == true){
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/sjjh/sjyz/del",
...
//              allowedFileExtensions:['xls'],//允许接受的文件后缀
                ...
                uploadUrl: '${pageContext.request.contextPath}/sjjh/sjyz/uploadfileinput'   //上传请求地址
            });
            //异步上传结果处理
    ...
    function addData(){
        ...
        //提交url
        var myurl = "${pageContext.request.contextPath}/sjjh/sjyz/insertsjjh";
        //成功方法
    ...
    function viewdata(uploadpath){
        ...
        $.ajax({
            ...
            dataType:'json',
            url:'${pageContext.request.contextPath}/sjjh/sjyz/filexists',
            success:function(data){
               if(data=='y'){
                   window.location.href = "${pageContext.request.contextPath}/sjjh/sjyz/downdata?uploadpath="+uploadpath;
               }else{
                   alert("文件不存在或已经损坏");
               }
            }
