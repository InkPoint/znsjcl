   ...
   // 数据产品主题的循环放置
    $(function(){
        $.ajax({
            type:'post',
            dataType:'json',
            url:'${pageContext.request.contextPath}/sjyj/sjcpzt/cpztlist',
            success:function(data){
                $.each(data,function(i,obj){
                    $("#mytable").append('<div class="col-sm-3" style="border-spacing: 15px; margin-bottom: 15px; height: 200px;">' +
                                            ...
                                            '<div class="panel-footer" style="text-align: center;"><a href="${pageContext.request.contextPath}/sjyj/sjcpzt/initsjcpztxz?ztid='+obj.ztid+'&'+'ztmc='+obj.ztmc+'">进入</a></div>' +
                                            '</div></div>');
                });
            }
        });
