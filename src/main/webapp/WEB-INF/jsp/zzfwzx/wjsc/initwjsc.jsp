    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    <%--数据项(表)信息展示--%>
                    <table id="viewtables" class="table table-striped table-bordered table-hover" data-height="680"
                    ...
                    <form id="fileinputForm" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2" style="width: 250px">
                                <input type="text" class="form-control" id="wjsm"/>
                            </div>
...
//            filetype = data.files[0].type;
            $('#fileinputwjmc').val(wjmc);
            var nsize = Math.round(size / 1024) + 'KB';
            $('#model-wjdx').val(nsize);
            $('#model-wjlx').val('.xls');

            $.ajax({
                url: "${pageContext.request.contextPath}/zzfwzx/wjsc/readExcelColumns",
                dataType: 'json',
                data: {filepath: wjmc},
...
//        alert(dxmczw)
        ...
        var parmssss = {rwsm:rwsm,bz:bz, wjmc: wjmc, wjlx: wjlx, wjdx: wjdx, solumns: colu, sjb: mbbid,  mbbmc: mbbmc,dxmcyw:dxmcyw};
        var myurl = "${pageContext.request.contextPath}/zzfwzx/wjsc/savewjxx";
    ...
    function getTableData(searchwjmc, rwmc) {
        ...
        //提交url
        var myurl = "${pageContext.request.contextPath}/zzfwzx/wjsc/getTableData";
        //成功方法
        var myfunctions = function (msg) {
            $('#mytable').bootstrapTable("destroy");
            initbootstrap(msg);
    ...
    function initbootstrap(getdata) {
        $('#mytable').bootstrapTable({
            ...
            paginationLoop: true,
            uniqueId: 'drid',
            uniqueIS: "drid", //每一行的唯一标识，一般为主键列框
...
//                },
                {
                    ...
                    title: '导入数据查看',
                    formatter: function (value, row, index) {
                        return '[<a style="color:#057afd;" href="javascript:void(0);" onclick="myviewdata(\'' + row.rwmc + '\')">查看数据</a>]';
