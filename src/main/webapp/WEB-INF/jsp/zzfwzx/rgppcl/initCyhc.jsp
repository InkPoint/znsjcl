...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
              href="${pageContext.request.contextPath}/assets/css/bootstrap-editable.css"/>
    </head>
    <body>
    <!-- Page Body -->
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="12" align="center">
                                    ...
                                    <button type="button" onclick=" quertlist()" class="btn btn-info"
                                            style="width: 2cm;">
                                        执行查询
                                    </button>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        ...
                        <table class="table table-striped table-responsive table-bordered table-hover"
                               style="white-space: nowrap" id="taskList" data-height="480">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        //初始化表格
        function inittabs(sjb, cjsjbegin, cjsjend) {
            //先销毁表格
            $('#taskList_table').bootstrapTable('destroy');
            $('#taskList_table').bootstrapTable({
                url: "${pageContext.request.contextPath}/zzfwzx/rgppcl/selectHc",
                ...
                onEditableSave: function (field, row, oldValue, $el) {
                    $.ajax({
                        type: "post",
                        url: "${pageContext.request.contextPath}/zzfwzx/rgppcl/selectHcqr",
                        data: {wid: row.wid, wfpp: row.sh},
                        dataType: "json",
        ...
        function quertlist() {
            var sjb = $("#sjb").val();
            var cjsjbegin = $("#cjsjbegin").find("input").val();
            var cjsjend = $("#cjsjend").find("input").val();
            inittabs(sjb, cjsjbegin, cjsjend);
        }
    ...
    <script>
        ...
        function mytable(nsrmcs) {
            ...
            $('#taskList').bootstrapTable({
                url: "${pageContext.request.contextPath}/sjcl/rgppcl/selecrPpxx",
//            search: true, //是否启用搜素
