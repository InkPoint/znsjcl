                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td colspan="12" align="center">
                                    ...
                                    <button type="button" onclick=" searchlist1()" class="btn btn-info"
                                            style="width: 2cm;">
                                        执行查询
                                    </button>
    ...
    <script>
        ...
        function inittabs(sjb, sjly) {
            ...
            $('#taskList_table').bootstrapTable({
                url: "${pageContext.request.contextPath}/zzfwzx/rgppcl/selectJc",
...
//                    },
                ...
                onEditableSave: function (field, row, oldValue, $el) {
                    $.ajax({
                        ...
                        data: {wid: row.wid, orgcode: row.xffj, wfpp: row.wfpp},
                        dataType: "json",
