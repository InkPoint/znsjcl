                    ...
                    <table class="table">
                        ...
                        <tr align="center">
                            <td colspan="12">
                                ...
                                <button onclick="gohistory()" type="button" class="btn btn-info" style="width: 2cm"
                                        >返回</button>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="col-xs-12 col-md-12">
            <div class="widget">
                ...
                <div class="widget-body">
                    ...
                    <table id="taskList_table" class="table table-striped table-bordered table-hover" data-height="560"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        //(模型列表)下拉菜单
        $.ajax({
            url: "${pageContext.request.contextPath}/zzfwzx/fxrwdz/selectmxlb",
            dataType: 'json',
        ...
        //(执行周期)下拉菜单
        $.ajax({
            url: "${pageContext.request.contextPath}/zzfwzx/fxrwdz/selectZxzq",
            dataType: 'json',
            success: function (datas1) {
    ...
    function inittabs(rwmcs) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${pageContext.request.contextPath}/zzfwzx/fxrwdz/selectList",
...
//            'svo.zxsj': zxsj,
        ...
        //提交url
        var myurl = "${pageContext.request.contextPath}/zzfwzx/fxrwdz/insertRw";
//        //成功方法
    ...
    function xgbc() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/zzfwzx/fxrwdz/updateRw',
            type: 'post',
            data: {
    ...
    function btn_delete() {
        ...
        if (confirm(msg) == true) {
            $.ajax({
                url: "${pageContext.request.contextPath}/zzfwzx/fxrwdz/deleteRw",
                type: "post",
                data: {
                    'svo.rwid': rwids
            ...
            fields: {
                tjrwmc: {
                    ...
                    validators: {
                        ...
                        remote: {
                            url: "${pageContext.request.contextPath}/zzfwzx/fxrwdz/nameValidation",
