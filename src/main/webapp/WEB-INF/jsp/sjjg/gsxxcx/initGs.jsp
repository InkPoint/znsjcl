        ...
        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption">工伤保险信息</span>
                </div>
...
<script>
    ...
    function summary(){
        window.location.href="${ctx}/sjjg/gsxxcx/initGsxxcx";
    }
    function aFrontConver(){
        window.location.href="${ctx}/sjjg/gsdzd/initGsdzd";
    }
</script>
