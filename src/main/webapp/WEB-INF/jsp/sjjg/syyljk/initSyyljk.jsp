...
<html>
<head>
    <title>医疗和生育保险费分征收局、分经办机构收入统计表--经开区社会保障基金管理中心</title>
...
<script type="text/javascript">
    ...
    function inittabs(rwmcs) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${pageContext.request.contextPath}/sjjg/syyljk/selectList",
//            search: true, //是否启用搜素
...
//            showColumns: 'true', //是否显示内容列下拉框
    ...
    //文件导出
    function wjdc(){
        window.location.href = "${pageContext.request.contextPath}/sjjg/syyljk/sjdc"
    }
