            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table id="taskList_table" class="table table-striped table-bordered table-hover"
                           style="white-space: nowrap" data-height="580"></table>
                </div>
            </div>
        </div>
    </div>
...
//            showColumns: 'true', //是否显示内容列下拉框
            ...
            data: [{
                xh:'1',
                xx: '生育汇总',
                cksj:'<a href="${pageContext.request.contextPath}/sjjg/syhz/initSyhz">查看</a>'
            },{
                xh:'2',
                xx: '高新区社会保险基金管理中心 生育',
                cksj:'<a href="${pageContext.request.contextPath}/sjjg/syhzgx/initSyhzgx ">查看</a>'
            },{
                xh:'3',
                xx: '经开区社会保障基金管理中心 生育',
                cksj:'<a href="${pageContext.request.contextPath}/sjjg/syhzjk/initSyhzjk ">查看</a>'
            },{
                xh:'4',
                xx: '西安市航天基地社保中心  生育',
                cksj:'<a href="${pageContext.request.contextPath}/sjjg/syhzhtjd/initSyhzhtjd  ">查看</a>'
            }
