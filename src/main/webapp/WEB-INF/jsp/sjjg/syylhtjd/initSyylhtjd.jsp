...
<html>
<head>
    <title>医疗和生育保险费分征收局、分经办机构收入统计表--西安市航天基地社保中心</title>
...
<script type="text/javascript">
    ...
    function inittabs(rwmcs) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${pageContext.request.contextPath}/sjjg/syylhtjd/selectList",
//            search: true, //是否启用搜素
...
//            showColumns: 'true', //是否显示内容列下拉框
    ...
    //文件导出
    function wjdc(){
        window.location.href = "${pageContext.request.contextPath}/sjjg/syylhtjd/sjdc"
    }
