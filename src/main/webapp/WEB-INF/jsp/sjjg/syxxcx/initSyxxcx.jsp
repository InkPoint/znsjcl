        ...
        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header bg-blue">
                    <span id="headerid" class="widget-caption">失业信息查询</span>
                </div>
...
<script>
    function returndiv() {
        window.location.href = "${ctx}/sjjg/syxxcx/initSy";
    }
    ...
    $(function () {
        ...
        // 核算机关
        $.post("${ctx}/sjjg/syxxcx/organMenu", null, function (data) {
            $("#hsjg").select2({
                data: data,
                placeholder: '请选择',
                allowClear: true
        ...
        // 经办机构
        $.post("${ctx}/sjjg/syxxcx/mechanismMenu", null, function (data) {
            $("#jbjg").select2({
                data: data,
                placeholder: '请选择',
                allowClear: true
    ...
    function inittabs(hsjgcon, jbjgcon) {
        ...
        $('#mytab').bootstrapTable({
            url: "${ctx}/sjjg/syxxcx/countAll",//获取数据的Select地址
    ...
    function exportToExcel() {
        ...
        window.location.href = "${ctx}/sjjg/syxxcx/exportExcel?svo.hsjg=" + hsjgcon + "&" +"svo.sbjbjg=" + jbjgcon;
    }
