        ...
        <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12">
            <div class="widget">
                <div class="widget-header ">
                    <span class="widget-caption">失业保险信息</span>
                </div>
...
<script>
    ...
    function summary(){
        window.location.href="${ctx}/sjjg/syxxcx/initSyxxcx";
    }
    function aFrontConver(){
        window.location.href="${ctx}/sjjg/syfp/initSyfp";
    }
</script>
