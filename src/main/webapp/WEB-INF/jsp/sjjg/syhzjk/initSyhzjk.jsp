...
<script type="text/javascript">
    ...
    function inittabs(rwmcs) {
        ...
        $('#taskList_table').bootstrapTable({
            url: "${pageContext.request.contextPath}/sjjg/syhzjk/selectSyhcjk",
//            search: true, //是否启用搜素
...
//            showColumns: 'true', //是否显示内容列下拉框
    ...
    //文件导出
    function wjdc(){
        window.location.href = "${pageContext.request.contextPath}/sjjg/syhzjk/sjdc"
    }
