...
<%--//            showColumns: 'true', //是否显示内容列下拉框--%>
            ...
            <%--}, {--%>
                ...
                <%--formatter: function (value, row, index) {--%>
                    <%--if (row.cpmc == '新增市场主体名单') {--%>
                        <%--return '<button type="button" class="btn btn-info btn-sm" onclick="newMarketParticipantsList(\'' + row.cpid + '\',\'' + row.cpmc + '\',\'' + row.cpcxjb + '\',\'' + row.cpbtzw + '\')">查看</button>';--%>
                    <%--}else {--%>
    ...
    <%--//新增市场主体数据查看定制页--%>
    <%--function newMarketParticipantsList(cpid, cpmc, cpcxjb,cpbtzw) {--%>
        <%--// 先装在批次下拉列表数据--%>
        <%--$.ajax({--%>
