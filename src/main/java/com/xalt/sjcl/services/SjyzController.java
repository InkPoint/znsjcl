...
import com.xalt.sjcl.model.SjyzVO;
...
public class SjyzController extends WebServiceSupport{
    ...
    public void list(SjyzVO svo, int limit, int offset, String sort, String order){
        ...
        param.put("svo",svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjcl.dao.SjyzMapper.list",param, offset, limit);
    ...
    public void del(SjyzVO svo){
        ...
        Map<String,Object> param = Maps.newHashMap();
        param.put("svo",svo);
        delegateMapper.update("com.xalt.sjcl.dao.SjyzMapper.del",param);
        includeJson("删除成功!");
    }
    //文件上传
...
//        final String allowFileSuffix="xls";
    ...
    public void insertsjjh(SjyzVO svo){
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        delegateMapper.insert("com.xalt.sjcl.dao.SjyzMapper.insertsjjh", param);
        includeJson("添加成功！");
    }
