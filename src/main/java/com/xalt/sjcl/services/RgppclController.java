...
import com.xalt.sjcl.model.RgppclVo;
...
public class RgppclController extends WebServiceSupport {
    ...
    public void initRgppcl() {
        ...
        try{
            utils.addCloudydata(mapper,"人工匹配",this.getUserPrincipal().getUserCode(),"sjcl/rgppcl/initRgppcl");
        }catch (Exception e){
    ...
    public void initSdhc() {
        DelegateMapper mapper = getMapper();
        try{
            utils.addCloudydata(mapper,"实地核查",this.getUserPrincipal().getUserCode(),"sjcl/rgppcl/initSdhc");
        }catch (Exception e){
    ...
    public void initCyhc() {
        DelegateMapper mapper = getMapper();
        try{
            utils.addCloudydata(mapper,"抽样核查",this.getUserPrincipal().getUserCode(),"sjcl/rgppcl/initCyhc");
        }catch (Exception e){
    ...
    public void selectSjb() {
        DelegateMapper mapper = getMapper();
        List sjb = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectSjb");  //数据表查询
        List shyy = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectShyy");//审核原因
        List xffj = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectZddw");//下发分局
        List ppy = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectPpyy");//匹配源查询
        List wfppyj_jc = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectPpyy_jc");//基层局无法匹配原因
    ...
    public void selectList(RgppclVo svo, int limit, int offset, String sort, String order) {
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = mapper.selectPaginated("com.xalt.sjcl.dao.RgppclMapper.selectAll", param, offset, limit);
    ...
    public void viewthedata(RgppclVo svo) {
        if(svo == null){
            svo = new RgppclVo();
        }
        ...
        Map<String,Object> param = Maps.newHashMap();
        param.put("svo",svo);
        List columnlist = delegateMapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectLm",param);
        ...
        //  if(ybywm != "" && ybywm != null ){
        //拼接查询sql
        String ysbsql = "select " + columns + " from " + ybywm + " where  znsjcl_id" + "=" + "'" + wid + "'";
    ...
    public void selectJc(RgppclVo svo, int limit, int offset, String sort, String order) {
        ...
        svo.setXfdw(this.getUserPrincipal().getOrgCode());
        param.put("svo", svo);
        PaginatedVO vo = mapper.selectPaginated("com.xalt.sjcl.dao.RgppclMapper.selectJc", param, offset, limit);
        Map<String, Object> results = new HashMap<String, Object>();
        results.put("total", vo.getPageCount());
        results.put("rows", vo.getRows());
        includeJson(vo);
    ...
    public void selectHc(RgppclVo svo, int limit, int offset, String sort, String order) {
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = mapper.selectPaginated("com.xalt.sjcl.dao.RgppclMapper.selectCyhc", param, offset, limit);
        Map<String, Object> results = new HashMap<String, Object>();
        results.put("total", vo.getPageCount());
        results.put("rows", vo.getRows());
        includeJson(vo);
    ...
    public void selecrPpxx(RgppclVo svo, int limit, int offset, String sort, String order) {
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = mapper.selectPaginated("com.xalt.sjcl.dao.RgppclMapper.selectPpys", param, offset, limit);
        Map<String, Object> results = new HashMap<String, Object>();
        results.put("total", vo.getPageCount());
        results.put("rows", vo.getRows());
        includeJson(vo);
    ...
    //市局确认匹配
    public void qrpp(String datalist) {
        int j = 0;
        DelegateMapper delegateMapper = getMapper();
        ...
        for(Object vo:myulist){
            ...
            param.put("svo",svo);
            int msg = delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.qrpp", param);
            j++;
        }
        if (j == 0) {
            //0失败
    ...
    public void qrppjc(String datalist,String xfdw){
        ...
        for(Object vo:myulist){
            ...
            param.put("ppdw", this.getUserPrincipal().getOrgCode());
            param.put("svo",svo);
            int msg = delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.qrppjc", param);
            j++;
        }
        if (j == 0) {
            //0失败
    ...
    //下发基层分局或者无法匹配
    public void xfjcfj(String wid, String xfdw, String wfpp) {
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("wid", wid);
        param.put("wfpp", wfpp);
        ...
        if ("".equals(xfdw) || null == xfdw) {
            //无法匹配
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.rgpp_wfpp", param);
        } else {
            //下发基层
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.rgpp_xffj", param);
        }
        includeJson("good");
    }
    ...
    public void selectHcqr(String wid, String wfpp,String wfppyy) {
        ...
        if ("2".equals(wfpp)) {
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.shcg", param);
        } else {
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.shbcg", param);
    ...
    public void ppdwcx(){
        ...
        List vo = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.zddwcx", mp);
        includeJson(vo);
    }
    ...
    public void jcjwfpp(String wid,  String wfpp,String xfr,String xfdw){
      ...
      //  param.put("xfr", this.getUserPrincipal().getUserCode());//下发人
        ...
        //判断该数据是否属于当前分局
        if(wfpp.equals("3")){
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.jcjbugfj", param);
        }else {
            delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.rgpp_wfpp", param);
        }
    ...
    public void rwcx(){
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("ppr",this.getUserPrincipal().getUserCode());
        delegateMapper.update("com.xalt.sjcl.dao.RgppclMapper.cxcx", param);
        includeJson("ok");
    }
    ...
    public void cyhcPpr(){
        DelegateMapper mapper = getMapper();
        Map<String, Object> mp = new HashMap<String, Object>();
        List vo = mapper.selectList("com.xalt.sjcl.dao.RgppclMapper.selectHcr", mp);
        includeJson(vo);
    }
