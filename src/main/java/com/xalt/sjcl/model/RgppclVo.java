 ...
 * 人工匹配
 */
public class RgppclVo extends BaseVO {
    ...
    private String gdghlxmc;
    private String swjgmc;
    private String djrq;
    private String zzjglxmc;
    private String kqccsztdjbz;
    private String swjgmc1;
    private String swjgmc2;
    private String swryxm;
    private String swryxm1;
    private String lrrq;
    private String swryxm2;
    private String xgrq;
    ...
    private String cjsjbegin;
    private String cjsjend;
    private String value;
    private String pprszdw;
    private String zgswjgdm;
    private String znsjclid;
    private String wfppyy;
    private String wfppyj_jc;
    private String xfry;
    private String scxffj;

    public String getScxffj() {
        return scxffj;
    }

    public void setScxffj(String scxffj) {
        this.scxffj = scxffj;
    }
    ...
    public String getXfry() {
        return xfry;
    }

    public void setXfry(String xfry) {
        this.xfry = xfry;
    }

    public String getWfppyj_jc() {
        return wfppyj_jc;
    }

    public void setWfppyj_jc(String wfppyj_jc) {
        this.wfppyj_jc = wfppyj_jc;
    }

    public String getZnsjclid() {
        return znsjclid;
    }

    public void setZnsjclid(String znsjclid) {
        this.znsjclid = znsjclid;
    }
    ...
    public String getPprszdw() {
        return pprszdw;
    }

    public void setPprszdw(String pprszdw) {
        this.pprszdw = pprszdw;
    }
    ...
    public String getWfpp() {
        return wfpp;
    }

    public void setWfpp(String wfpp) {
        this.wfpp = wfpp;
    }
    ...
    public String getPpdw() {
        return ppdw;
    }

    public void setPpdw(String ppdw) {
        this.ppdw = ppdw;
    }
    ...
    public String getGdslxmc() {
        return gdslxmc;
    }

    public void setGdslxmc(String gdslxmc) {
        this.gdslxmc = gdslxmc;
    }
    ...
    public String getGdghlxmc() {
        return gdghlxmc;
    }

    public void setGdghlxmc(String gdghlxmc) {
        this.gdghlxmc = gdghlxmc;
    }
    ...
    public String getSwjgmc1() {
        return swjgmc1;
    }

    public void setSwjgmc1(String swjgmc1) {
        this.swjgmc1 = swjgmc1;
    }

    public String getSwjgmc2() {
        return swjgmc2;
    }

    public void setSwjgmc2(String swjgmc2) {
        this.swjgmc2 = swjgmc2;
    }
    ...
    public String getSwryxm1() {
        return swryxm1;
    }

    public void setSwryxm1(String swryxm1) {
        this.swryxm1 = swryxm1;
    }
    ...
    public String getSwryxm2() {
        return swryxm2;
    }

    public void setSwryxm2(String swryxm2) {
        this.swryxm2 = swryxm2;
    }
    ...
    public String getWfppyy() {
        return wfppyy;
    }

    public void setWfppyy(String wfppyy) {
        this.wfppyy = wfppyy;
    }
}
