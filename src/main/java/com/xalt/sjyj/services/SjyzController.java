...
import com.xalt.sjyj.model.SjyzVO;
...
public class SjyzController extends WebServiceSupport{
    ...
    public void initSjyz(){
        ...
        try{
            utils.addCloudydata(mapper,"数据研究-数据验证",this.getUserPrincipal().getUserCode(),"sjyj/sjyz/initSjyz");
        }catch (Exception e){
    ...
    public void list(SjyzVO svo, int limit, int offset, String sort, String order){
        ...
        param.put("svo",svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjyj.dao.SjyzMapper.list",param, offset, limit);
    ...
    public void del(SjyzVO svo){
        ...
        Map<String,Object> param = Maps.newHashMap();
        param.put("svo",svo);
        delegateMapper.update("com.xalt.sjyj.dao.SjyzMapper.del",param);
        includeJson("删除成功!");
    }
    //文件上传
...
//        final String allowFileSuffix="xls";
    ...
    public void insertsjjh(SjyzVO svo){
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        delegateMapper.insert("com.xalt.sjyj.dao.SjyzMapper.insertsjjh", param);
        includeJson("添加成功！");
    }
