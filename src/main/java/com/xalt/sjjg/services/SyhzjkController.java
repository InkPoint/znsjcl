...
@Controller
public class SyhzjkController extends WebServiceSupport {
@Inject
    private Logger log;
    ...
    public void selectSyhcjk(SyhzVo svo,int limit, int offset, String sort, String order){
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.SyhzjkMapper.selectSyhzjk", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.SyhzjkMapper.selectSyhzjk");
