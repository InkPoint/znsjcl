 ...
 * 医疗和生育保险费分征收局、分经办机构收入统计表--经开区社会保障基金管理中心
 */


@Controller
public class SyyljkController extends WebServiceSupport {
    ...
    public void selectList(SyYlGxVo svo,int limit, int offset, String sort, String order){
        ...
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.SyyljkMapper.selectAll", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.SyyljkMapper.selectAll");
        String bt1="医疗和生育保险费分征收局、分经办机构收入统计表";
        String bt2 = "主管经办机构：经开区社会保障基金管理中心";
