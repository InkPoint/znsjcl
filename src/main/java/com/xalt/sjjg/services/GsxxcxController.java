...
import com.xalt.sjjg.model.GsxxcxVO;
 ...
 */
@Controller
public class GsxxcxController extends WebServiceSupport {
    @Inject
    ...
    public void initGsxxcx() {
        DelegateMapper mapper = getMapper();
        try {
            utils.addCloudydata(mapper, "工伤信息查询", this.getUserPrincipal().getUserCode(), "sjjg/gsxxcx/initGsxxcx");
        } catch (Exception e) {
     ...
     * @param order
     */
    public void countAll(GsxxcxVO svo, int limit, int offset, String sort, String order) {
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.GsxxcxMapper.countAll", param, offset, limit);
    ...
    public void organMenu() {
        DelegateMapper mapper = getMapper();
        List vo = mapper.selectList("com.xalt.sjjg.dao.GsxxcxMapper.organMenu");
        includeJson(vo);
    }
    ...
    public void mechanismMenu() {
        DelegateMapper mapper = getMapper();
        List vo = mapper.selectList("com.xalt.sjjg.dao.GsxxcxMapper.mechanismMenu");
        includeJson(vo);
    }
    ...
    public void exportDate(GsxxcxVO svo) {
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo",svo);
        List list = delegateMapper.selectList("com.xalt.sjjg.dao.GsxxcxMapper.countAll",param);
     ...
     * @throws Exception
     */
    public Download exportExcel(GsxxcxVO svo,HttpServletResponse response) throws Exception {
        List<HashMap<String, Object>> listMap = new ArrayList<>();

        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        List listData = delegateMapper.selectList("com.xalt.sjjg.dao.GsxxcxMapper.exportCountAll", param);
        if (listData.size() > 65536) {
