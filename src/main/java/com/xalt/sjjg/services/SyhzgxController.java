...
@Controller
public class SyhzgxController extends WebServiceSupport {
    ...
    public void initSyhzgx(){

   }

    //基本数据查询

    public void selectSyhcgx(SyhzVo svo,int limit, int offset, String sort, String order){
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.SyhzgxMapper.selectSyhzgx", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.SyhzgxMapper.selectSyhzgx");
