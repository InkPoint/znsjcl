...
/**
 * Created by cuihengon 2018/7/31.
 * 高新区社会保险基金管理中心 医疗
 *
 */
...
@Controller
public class YlhzgxController extends WebServiceSupport {
    ...
    public void sellectList(YlhzVo svo, int limit, int offset, String sort, String order){
        ...
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.YlhzGxMapper.selectAll", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.YlhzGxMapper.selectAll");
