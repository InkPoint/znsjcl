...
import com.xalt.sjjg.model.SyhzVo;
...
/**
 * Created by cuiheng on 2018/7/30.
 * 西安市航天基地社保中心  生育
 */

@Controller
public class SyhzhtjdController extends WebServiceSupport {
    ...
    public void selectSyhchtjd(SyhzVo svo,int limit, int offset, String sort, String order){
        DelegateMapper delegateMapper = getMapper();
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.SyhzhtjdMapper.selectSyhzhtjd", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.SyhzhtjdMapper.selectSyhzhtjd");
