...
@Controller
public class YlhzjkController extends WebServiceSupport {
    ...
    public void sellectList(YlhzVo svo, int limit, int offset, String sort, String order){
        ...
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.YlhzJkMapper.selectAll", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.YlhzJkMapper.selectAll");
