 ...
 * 医疗和生育保险费分征收局、分经办机构收入统计表--西安市航天基地社保中心
 */

@Controller
public class SyylhtjdController extends WebServiceSupport {
    ...
    public void selectList(SyYlGxVo svo,int limit, int offset, String sort, String order){
        ...
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjg.dao.SyylhtjdMapper.selectAll", param, offset, limit);
    ...
    public void sjdc() {
        DelegateMapper delegateMapper = getMapper();
        List ls = delegateMapper.selectList("com.xalt.sjjg.dao.SyylhtjdMapper.selectAll");
        String bt1="医疗和生育保险费分征收局、分经办机构收入统计表";
        String bt2 = "医疗和生育保险费分征收局、分经办机构收入统计表--西安市航天基地社保中心";
