...
/**
 * Created by cuihegn on 2018/3/9.
 * 文件上传
 */
public class WjscVo extends BaseVO {
    private String drid;
//    private String ywbm;
    private String wjmc;
    private String scsj;
    private String wjlx;
    private String scr_dm;
    private String scr;
    ...
    public String getScr_dm() {
        return scr_dm;
    }

    public void setScr_dm(String scr_dm) {
        this.scr_dm = scr_dm;
    }
    ...
    public void setDrry(String drry) {
        this.drry = drry;
    }
    ...
    public String getSjdrsj() {
        return sjdrsj;
    }

    public void setSjdrsj(String sjdrsj) {
        this.sjdrsj = sjdrsj;
    }
    ...
    public String getSqrscwjsj() {
        return sqrscwjsj;
    }

    public void setSqrscwjsj(String sqrscwjsj) {
        this.sqrscwjsj = sqrscwjsj;
    }
