...
import com.xalt.sjjh.model.SjyzVO;
...
public class SjyzController extends WebServiceSupport {
    ...
    public void initSjyz() {
        ...
        try{
            utils.addCloudydata(mapper,"数据交换—数据验证",this.getUserPrincipal().getUserCode(),"sjjh/sjyz/initSjyz");
        }catch (Exception e){
    ...
    public void list(SjyzVO svo, int limit, int offset, String sort, String order) {
        ...
        param.put("svo", svo);
        PaginatedVO vo = delegateMapper.selectPaginated("com.xalt.sjjh.dao.SjyzMapper.list", param, offset, limit);
    ...
    public void del(SjyzVO svo) {
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        delegateMapper.update("com.xalt.sjjh.dao.SjyzMapper.del", param);
        includeJson("删除成功!");
    }
...
//        final String allowFileSuffix="xls";
    ...
    public void insertsjjh(SjyzVO svo) {
        ...
        Map<String, Object> param = Maps.newHashMap();
        param.put("svo", svo);
        delegateMapper.insert("com.xalt.sjjh.dao.SjyzMapper.insertsjjh", param);
        includeJson("添加成功！");
    }
